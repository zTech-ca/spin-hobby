...
export default function ImageSlider() {
	...
	const imageSource = ['https://drive.google.com/uc?id=1GyPJxF36hlp2JS7SeYrnW0Bmuc9KJyBq', 'https://drive.google.com/uc?id=1MIbogRkUdngQXnaXT8Mufup-7CScTNRj', 'https://drive.google.com/uc?id=1a_w8OcDV-IA5UMz7usKtO_lXf0YSee3u', 'https://drive.google.com/uc?id=1gLp3gryMbGYpgAfAtnDGccME1lCzEyUU', 'https://drive.google.com/uc?id=1iOOVa8mOrESI0o5o7au7nAOlPFAwbnLM'];

  	return (
  	  <Previewer imageSource={imageSource} />
  	);
}
